# Curriculum Matcher Handoff v027
...
- read the latest handoff and live tracker from the active OneDrive-backed workspace before touching the roadmap
...
> Resume work on the curriculum matcher from `/Users/ericseverson/Library/CloudStorage/OneDrive-Personal/VS Code/curriculum-matcher/docs/handoffs/2026-04-06-v027-e1-still-blocked-handoff.md`.
>
